...
!function(i){skel.breakpoints({xlarge:"(max-width: 1680px)",large:"(max-width: 1280px)",medium:"(max-width: 980px)",small:"(max-width: 736px)",xsmall:"(max-width: 480px)"}),i(function(){var e=i(window),n=i("body"),a=i("#menu"),s=i("#sidebar"),o=i("#main"),t=i(".pagination");n.addClass("is-loading"),e.on("load",function(){window.setTimeout(function(){n.removeClass("is-loading")},100)}),i("form").placeholder(),skel.on("+medium -medium",function(){i.prioritize(".important\\28 medium\\29",skel.breakpoint("medium").active)}),skel.vars.IEVersion<=9&&o.insertAfter(s),a.appendTo(n).panel({delay:500,hideOnClick:!0,hideOnSwipe:!0,resetScroll:!0,resetForms:!0,side:"right",target:n,visibleClass:"is-menu-visible"});var l=i("#search"),d=l.find("input");n.on("click",'[href="#search"]',function(i){i.preventDefault(),l.hasClass("visible")||(l[0].reset(),l.addClass("visible"),d.focus())}),d.on("keydown",function(i){27==i.keyCode&&d.blur()}).on("blur",function(){window.setTimeout(function(){l.removeClass("visible")},100)});var r=i("#intro");skel.on("+large",function(){r.prependTo(o)}).on("-large",function(){r.prependTo(s)}),t.addClass("actions").each(function(){i(this).find("a, span").addClass("button big")})})}(jQuery);
//# sourceMappingURL=app-front.min.js.map
